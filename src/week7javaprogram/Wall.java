...
constructor). The second constructor has parameters width and height of type doubleand it needs to
...
public class Wall
{
    ...
    public Wall()               //constructor calling
    {

    }
    public Wall(double width, double height)        //constructor calling with parameter
    {
        if(width<0)
        {
            width=0;
    ...
    public double getWidth()            //instance method calling
    {
        return width;
    }
    ...
    public double getArea() //area calculation in instance method
    {
